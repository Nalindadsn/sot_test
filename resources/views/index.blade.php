              ...
              <div class="col-md-10"  style="background-color: white">
                  ...
                  {{--<div role="tabpanel" class="tab-pane fade show active" id="sale-latest">--}}
                    <div class="table-responsive" style="background-color: white">
                      <table class="table" style="background-color: white">
                        ...
                        <tbody>
                        @foreach($sales_sources as $ss)
                            <tr>
                              <td>{{$ss->name}}</td>
                              <td class="ss_count_{{$ss->id}}">{{$ss->sales_count}}</td>
                              <td class="ss_{{$ss->id}}">{{number_format((float)$ss->tot_sale, 2, '.', '')}}</td>
                            </tr>
                        @endforeach
                        </tbody>
                      </table>
                ...
                {{--<div class="col-sm-2">--}}
                  {{--<div class="wrapper count-title text-center">--}}
                    {{--<div class="name"  style="color: #733686;font-size: 13px">{{$ss->name}}</div>--}}
                    {{--<div class="count-number ss_{{$ss->id}}" style=" font-size: 15px">{{number_format((float)$ss->tot_sale, 2, '.', '')}}</div>--}}
                    {{--<div class="count-number ss_count_{{$ss->id}}" style=" font-size: 15px">Sales QTY - {{$ss->sales_count}}</div>--}}
                  {{--</div>--}}
                {{--</div>--}}
                      ...
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>{{ date($general_setting->date_format, strtotime($sale->created_at)) }}</td>
