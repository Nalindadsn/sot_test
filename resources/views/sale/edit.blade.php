                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="date" name="invoice_date" class="form-control" required value="{{date('Y-m-d', strtotime($lims_sale_data->created_at))}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                {{--<div class="row">--}}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="sales_source_id_hidden" value="{{$lims_sale_data->sales_source}}" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="hidden" name="payment_status_hidden" value="{{$lims_sale_data->payment_status}}" />
                                        <div class="form-group">
