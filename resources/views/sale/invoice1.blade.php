...
{{--<div style="max-width:400px;margin:0 auto">--}}
    ...
    <div id="receipt-data">
            ...
            <tr>
                ...
                <td style="width: 40%;align-content: right" align="right">
                    <table style="border: black 1px solid">
                        ...
                        <tr>
                            <td style="width: 50%;border: black 1px solid" align="center">
                                <h2>{{ \Carbon\Carbon::parse($lims_sale_data->created_at)->format('d/m/Y')}}</h2>
                            </td>
                            <td style="width: 50%;border: black 1px solid" align="center">
                                <h2>{{$lims_sale_data->reference_no}}</h2>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table>
                        ...
                        <tr style="border: black 1px solid;min-height: 50px">
                            <td>
                                {{$lims_sale_data->customer->name}}
                                <br>
                                {{$lims_sale_data->customer->address}}
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table class="table-data">
            <thead>
            <tr>
                <th style="min-width:200px!important;width: 60%;border: 1px solid black;">Item</th>
                <th style="min-width:200px!important;width: 60%;border: 1px solid black;">Item Description</th>
                {{--<td>Description</td>--}}
            ...
            <tbody>
                ...
                $product_des = $lims_product_data->product_details;
                ...
                <tr>
                    <td style="width: 60%;border: 1px solid black">{{$product_name}}</td>
                    <td style="width: 60%;border: 1px solid black">{{$product_des}}</td>
{{--                    <td>{{$lims_product_data->description}}</td>--}}
                    <td style="width: 5px;border: 1px solid black" align="center">{{$product_sale_data->qty}}</td>
                    <td style="min-width:10%;width: 18%;border: 1px solid black" align="right"> {{number_format((float)($product_sale_data->total / $product_sale_data->qty), 2, '.', '')}}
                    ...
                    <td style="width: 18%;border: 1px solid black" align="right">{{number_format((float)$product_sale_data->total, 2, '.', '')}}</td>
                </tr>
            ...
            <!-- <tfoot> -->
                <tr>
                    ...
                    <th style="width: 50%;">
                        <table>
                            <tr>
                                <th style="text-align:left;width: 60%;">{{trans('file.Total')}}</th>
                                <th style="text-align:right;width: 40%;">{{number_format((float)$lims_sale_data->total_price, 2, '.', '')}}</th>
                            </tr>

                            @if($general_setting->invoice_format == 'gst' && $general_setting->state == 1)
                                <tr>
                                    <td  style="text-align:left;width: 60%;">IGST</td>
                                    <td style="text-align:right;width: 40%;">{{number_format((float)$total_product_tax, 2, '.', '')}}</td>
                                </tr>
                            @elseif($general_setting->invoice_format == 'gst' && $general_setting->state == 2)
                                <tr>
                                    <td  style="text-align:left;width: 60%;">SGST</td>
                                    <td style="text-align:right;width: 40%;">{{number_format((float)($total_product_tax / 2), 2, '.', '')}}</td>
                                </tr>
                                <tr>
                            ...
                            @if($lims_sale_data->order_tax)
                                <tr>
                                    <th style="text-align:left;width: 60%;" style="text-align:left">{{trans('file.Order Tax')}}</th>
                                    <th style="text-align:right;width: 40%;">{{number_format((float)$lims_sale_data->order_tax, 2, '.', '')}}</th>
                                </tr>
                            @endif
                            @if($lims_sale_data->order_discount)
                                <tr>
                                    <th style="text-align:left;width: 60%;" style="text-align:left">{{trans('file.Order Discount')}}</th>
                                    <th style="text-align:right;width: 40%;">{{number_format((float)$lims_sale_data->order_discount, 2, '.', '')}}</th>
                                </tr>
                            @endif
                            @if($lims_sale_data->coupon_discount)
                                <tr>
                                    <th style="text-align:left;width: 60%;" style="text-align:left">{{trans('file.Coupon Discount')}}</th>
                                    <th style="text-align:right;width: 40%;">{{number_format((float)$lims_sale_data->coupon_discount, 2, '.', '')}}</th>
                                </tr>
                            @endif
                            @if($lims_sale_data->shipping_cost)
                                <tr>
                                    <th style="text-align:left;width: 60%;" style="text-align:left">{{trans('file.Shipping Cost')}}</th>
                                    <th style="text-align:right;width: 40%;">{{number_format((float)$lims_sale_data->shipping_cost, 2, '.', '')}}</th>
                                </tr>
                            @endif
                            <tr>
                                <th style="text-align:left;width: 60%;" style="text-align:left">{{trans('file.grand total')}}</th>
