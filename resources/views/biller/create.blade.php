                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input maxlength="2" value="0" type="text" name="commission_pre" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Sales Target</label>
                                    <input  value="0" type="text" name="sales_target" class="form-control" required>
                                </div>
                            </div>
                            {{--<div class="col-md-6">--}}
                                {{--<div class="form-group">--}}
                                    {{--<label>Completed Sales</label>--}}
                                    {{--<input maxlength="2" value="0" type="text" name="sales_target" class="form-control" required>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            <div class="col-md-12">
