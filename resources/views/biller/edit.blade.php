                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input maxlength="2" type="text" name="commission_pre" class="form-control" value="{{$lims_biller_data->commission_pre}}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Commission </label>
                                    <input maxlength="2" type="text" class="form-control" value="{{$lims_biller_data->commission}}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Sales Target</label>
                                    <input value="{{$lims_biller_data->sales_target}}" type="text" name="sales_target" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Completed Sales Target</label>
                                    <input type="text" value="{{$lims_biller_data->sales_achived}}" class="form-control"  readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
