                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="date" name="invoice_date" class="form-control" required value="<?php echo e(date('Y-m-d', strtotime($lims_sale_data->created_at))); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="sales_source_id_hidden" value="<?php echo e($lims_sale_data->sales_source); ?>" />
                                            <select required name="sales_source" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Sales Source...">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>
                                                            <input type="hidden" class="product-batch-id" name="product_batch_id[]" value="<?php echo e($product_sale->product_batch_id); ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="hidden" name="payment_status_hidden" value="<?php echo e($lims_sale_data->payment_status); ?>" />
                                        <div class="form-group">
...
$('select[name="sales_source"]').val($('input[name="sales_source_id_hidden"]').val());
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikinzico/system.secretsoftea.lk/backup/development/resources/views/sale/edit.blade.php ENDPATH**/ ?>