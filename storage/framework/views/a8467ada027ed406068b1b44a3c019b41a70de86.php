                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Commission </label>
                                    <input maxlength="2" type="text" name="commission" class="form-control" value="<?php echo e($lims_biller_data->commission); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salespro\resources\views/biller/edit.blade.php ENDPATH**/ ?>