                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input maxlength="2" type="text" name="commission_pre" class="form-control" value="<?php echo e($lims_biller_data->commission_pre); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Commission </label>
                                    <input maxlength="2" type="text" class="form-control" value="<?php echo e($lims_biller_data->commission); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Sales Target</label>
                                    <input value="<?php echo e($lims_biller_data->sales_target); ?>" type="text" name="sales_target" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Completed Sales Target</label>
                                    <input type="text" value="<?php echo e($lims_biller_data->sales_achived); ?>" class="form-control"  readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikinzico/system.secretsoftea.lk/backup/development/resources/views/biller/edit.blade.php ENDPATH**/ ?>