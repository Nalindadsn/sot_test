            ...
            <div class="col-md-6">
                <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                      <div class="form-group">
                                          <input type="text" id="reference-no" name="reference_no" class="form-control" placeholder="Type Invoice number" onkeyup='saveValue(this);'/>
                                      </div>
                                    ...
                                    <input hidden type="text" value="1" name="payment_status" id="payment_status" class="form-control" />
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select required id="sales_source" name="sales_source" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Sales Source...">
                                                <?php $__currentLoopData = $sales_sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sales_source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($sales_source->id); ?>"><?php echo e($sales_source->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="payment-options">
                        <div class="column-5">
                            <button style="background: #14ce8d" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cod-btn"><i class="fa fa-money"></i> COD</button>
                        </div>
                        <div class="column-5">
                        ...
                        <div class="column-5">
                            <button style="background: #0984e3" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="credit-card-btn"><i class="fa fa-credit-card"></i> Credit</button>
                        </div>
                        <div class="column-5">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6 mt-1" name="paying_amount_div">
                                            <label><?php echo e(trans('file.Recieved Amount')); ?> *</label>
                                            <input type="text" name="paying_amount" class="form-control numkey" required step="any" value="0.00">
                                        </div>
                                        <div class="col-md-6 mt-1" name="paid_amount_div">
...
$("#gift-card-btn").on("click",function() {
    $('div[name="paid_amount_div"]').show();
    $('div[name="paying_amount_div"]').show();
...
$("#cod-btn").on("click",function() {
    ...
    $('#payment_status').val("7");
    $('.selectpicker').selectpicker('refresh');
    $('div.qc').hide();
    $('input[name="paid_amount"]').val(0);
    $('input[name="paying_amount"]').val(0);
    $('div[name="paid_amount_div"]').hide();
    $('div[name="paying_amount_div"]').hide();
    hide();
});
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikinzico/system.secretsoftea.lk/development/develop2/resources/views/sale/pos.blade.php ENDPATH**/ ?>