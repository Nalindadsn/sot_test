			...
			<div class="col-md-3">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2"><?php echo e(trans('file.Discount')); ?> <span class="float-right"><?php echo e(number_format((float)$purchase[0]->discount, 2, '.', '')); ?></span></p>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2"><?php echo e(trans('file.Discount')); ?> <span class="float-right"><?php echo e(number_format((float)$sale[0]->discount, 2, '.', '')); ?></span></p>
					</div>
				</div>
			</div>
			<div class="col-md-3">
			...
			<div class="col-md-4">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2"><?php echo e(trans('file.Product Cost')); ?> <span class="float-right">- <?php echo e(number_format((float)$product_cost, 2, '.', '')); ?></span></p>
						<p class="mt-2"><?php echo e(trans('file.profit')); ?> <span class="float-right"> <?php echo e(number_format((float)($sale[0]->grand_total - $product_cost), 2, '.', '')); ?></span></p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2"><?php echo e(trans('file.profit')); ?> <span class="float-right"> <?php echo e(number_format((float)($sale[0]->grand_total - $product_cost - $return[0]->grand_total + $purchase_return[0]->grand_total), 2, '.', '')); ?></span></p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="colored-box">
					...
					<p class="text-center">
						(<?php echo e(trans('file.Sale')); ?> <?php echo e(number_format((float)($sale[0]->grand_total), 2, '.', '')); ?> - <?php echo e(trans('file.Tax')); ?> <?php echo e(number_format((float)($sale[0]->tax), 2, '.', '')); ?>) - (<?php echo e(trans('file.Product Cost')); ?> <?php echo e(number_format((float)($product_cost), 2, '.', '')); ?> - <?php echo e(trans('file.Tax')); ?> <?php echo e(number_format((float)($product_tax), 2, '.', '')); ?>) - (<?php echo e(trans('file.Return')); ?> <?php echo e(number_format((float)($return[0]->grand_total), 2, '.', '')); ?> - <?php echo e(trans('file.Tax')); ?> <?php echo e(number_format((float)($return[0]->tax), 2, '.', '')); ?>) + (<?php echo e(trans('file.Purchase Return')); ?> <?php echo e(number_format((float)($purchase_return[0]->grand_total), 2, '.', '')); ?> - <?php echo e(trans('file.Tax')); ?> <?php echo e(number_format((float)($purchase_return[0]->tax), 2, '.', '')); ?>) - (<?php echo e(trans('file.Expense')); ?> <?php echo e(number_format((float)($expense), 2, '.', '')); ?>)
					</p>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikinzico/system.secretsoftea.lk/backup/development/resources/views/report/profit_loss.blade.php ENDPATH**/ ?>