          ...
          <div class="modal-body">
              <div class="gift-card" style="margin: 0 auto; max-width: 350px; position: relative; color:#fff;"><img src="<?php echo e(url('public/images/gift_card/front.jpg')); ?>" width="350" height="200">
                <div style="position: absolute; padding: 15px; top:0; left: 0; width: 350px;">
                    <h3 class="d-inline">Gift Card</h3><h3 class="d-inline float-right"><?php echo e($currency->code); ?> <span id="balance"></span></h3>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u990238789/domains/sot.gitl.lk/public_html/resources/views/gift_card/index.blade.php ENDPATH**/ ?>