    ...
    <div class="table-responsive">
        <table id="return-table" class="table return-list">
            ...
            <tbody>
                ...
                <tr class="return-link" data-return='["<?php echo e(date($general_setting->date_format, strtotime($return->created_at->toDateString()))); ?>", "<?php echo e($return->reference_no); ?>",
                 "<?php echo e($return->warehouse->name); ?>",
                 "<?php echo e($return->biller->name); ?>",
                 "<?php echo e($return->biller->company_name); ?>",
                 "<?php echo e($return->biller->email); ?>", "<?php echo e($return->biller->phone_number); ?>", "<?php echo e($return->biller->address); ?>", "<?php echo e($return->biller->city); ?>",
                  "<?php echo e($return->customer->name); ?>", "<?php echo e($return->customer->phone_number); ?>", "<?php echo e($return->customer->address); ?>", "<?php echo e($return->customer->city); ?>", "<?php echo e($return->id); ?>", "<?php echo e($return->total_tax); ?>", "<?php echo e($return->total_discount); ?>", "<?php echo e($return->total_price); ?>", "<?php echo e($return->order_tax); ?>", "<?php echo e($return->order_tax_rate); ?>", "<?php echo e($return->grand_total); ?>", "<?php echo e($return->return_note); ?>", "<?php echo e($return->staff_note); ?>",
                   "<?php echo e($return->user->name); ?>", "<?php echo e($return->user->email); ?>"]'>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salespro\resources\views/return/index.blade.php ENDPATH**/ ?>