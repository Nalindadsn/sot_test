    ...
    <div id="receipt-data">
        <div class="centered">
            <?php if($general_setting->site_logo): ?>
                <img hidden src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" height="42" width="50" style="margin:10px 0;filter: brightness(0);">
            <?php endif; ?>
        ...
        <p><?php echo e(trans('file.Date')); ?>: <?php echo e($lims_sale_data->created_at); ?><br>
            Invoice #: <?php echo e($lims_sale_data->reference_no); ?><br>
            <?php echo e(trans('file.customer')); ?>: <?php echo e($lims_customer_data->name); ?><br>
            Mobile Number: <?php echo e($lims_customer_data->phone_number); ?><br>
            Address: <?php echo e($lims_customer_data->address); ?>
...
<?php /**PATH /home/ikinzico/system.secretsoftea.lk/backup/development/resources/views/sale/invoice.blade.php ENDPATH**/ ?>