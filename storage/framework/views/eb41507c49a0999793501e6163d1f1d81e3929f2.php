            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-2 form-group">
                        ...
                        <select class="form-control selectpicker" name="delivered_by" id="delivered_by">
                            <?php $__currentLoopData = $delivery_mans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery_man): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($delivery_man->name); ?>"><?php echo e($delivery_man->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-6 mt-2 form-group">
...
<script type="text/javascript">
    ...
    $('#sale-table').DataTable( {
        ...
        "createdRow": function( row, data, dataIndex ) {
            ...
            // var ccd = JSON.parse(data['sale']);
            var ccd = JSON.parse(data['sale']['30']);
            // console.log(ccd);
            // console.log('aaaa');
            // var result = parseInt($.trim(data['sale']['30']), 10);
            // console.log(result);
            // console.log('fff');
    ...
    function saleDetails(sale){
        ...
        var htmltext = '<strong><?php echo e(trans("file.Date")); ?>: </strong>'+sale[0]+'<br><strong>Invoice #: </strong>'+sale[1]+'<br><strong><?php echo e(trans("file.Warehouse")); ?>: </strong>'+sale[27]+'<br><strong><?php echo e(trans("file.Sale Status")); ?>: </strong>'+sale[2]+'<br><br><div class="row"><div class="col-md-6"><strong><?php echo e(trans("file.From")); ?>:</strong><br>'+sale[3]+'<br>'+sale[4]+'<br>'+sale[5]+'<br>'+sale[6]+'<br>'+sale[7]+'<br>'+sale[8]+'</div><div class="col-md-6"><div class="float-right"><strong><?php echo e(trans("file.To")); ?>:</strong><br>'+sale[9]+'<br>'+sale[10]+'<br>'+sale[11]+'<br>'+sale[12]+'</div></div></div>';
        $.get('sales/product_sale/' + sale[13], function(data){
            ...
            if (sale[30] == 1){
                var newRow = $("<tr style='background-color: green'>");
            } else{
                var newRow = $("<tr>");
            }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikinzico/system.secretsoftea.lk/development/develop2/resources/views/sale/index.blade.php ENDPATH**/ ?>