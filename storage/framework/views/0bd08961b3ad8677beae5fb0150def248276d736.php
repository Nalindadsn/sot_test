        ...
        <table id="biller-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($biller->id); ?>">
                    ...
                    <td><?php echo e($biller->commission_pre); ?></td>
                    <td><?php echo e($biller->commission); ?></td>
                    <td><?php echo e($biller->sales_target); ?></td>
                    <td><?php echo e($biller->sales_achived); ?></td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikinzico/system.secretsoftea.lk/backup/development/resources/views/biller/index.blade.php ENDPATH**/ ?>