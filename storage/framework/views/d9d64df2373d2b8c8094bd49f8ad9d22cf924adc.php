            ...
            <table id="delivery-table" class="table">
                ...
                <?php $__currentLoopData = $lims_delivery_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr class="delivery-link" data-barcode="<?php echo e($barcode); ?>"
                        ...
                        <?php if($delivery->sale->sales_source != null && $delivery->sale->sales_source !=''): ?>
                            <?php
                            //                        $SS = DB::table('sales_source')->where('id','=',$delivery->sale->sales_source)->select('sales_source.id','sales_source.name')->first();
                            $SS = DB::table('sales_source')->find($delivery->sale->sales_source);
                            ?>
                        ...
                        <?php if($delivery->status == 1): ?>
                            <td>
                                <div class="badge badge-info"><?php echo e($status); ?></div>
                            </td>
                        <?php elseif($delivery->status == 2): ?>
                            <td>
                                <div class="badge badge-primary"><?php echo e($status); ?></div>
                            </td>
                        <?php else: ?>
                            <td>
                        ...
                        <td><?php echo e($delivery->recieved_by); ?></td>
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <button type="button" data-id="<?php echo e($delivery->id); ?>"
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikinzico/system.secretsoftea.lk/backup/development/resources/views/delivery/index.blade.php ENDPATH**/ ?>