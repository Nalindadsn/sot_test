                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input maxlength="2" type="text" name="commission_pre" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikinzico/system.secretsoftea.lk/development/resources/views/biller/create.blade.php ENDPATH**/ ?>