        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 form-group">
              <div class="row">
                <!-- Count item widget-->
                <?php $__currentLoopData = $sales_sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-sm-2">
                  <div class="wrapper count-title text-center">
                    
                    <div class="name"  style="color: #733686;font-size: 13px"><?php echo e($ss->name); ?></div>
                    <div class="count-number ss_<?php echo e($ss->id); ?>" style=" font-size: 15px"><?php echo e(number_format((float)$ss->tot_sale, 2, '.', '')); ?></div>
                    <div class="count-number ss_count_<?php echo e($ss->id); ?>" style=" font-size: 15px">Sales QTY - <?php echo e($ss->sales_count); ?></div>
                  </div>
                </div>
                      ...
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td><?php echo e(date($general_setting->date_format, strtotime($sale->created_at))); ?></td>
...
<script type="text/javascript">
    ...
    function dashboardFilter(data){
        ...
        for (i=0; i < data[4].length ; i++ ) {
            console.log(data[4][i]['id']);

            $('.ss_'+data[4][i]['id']).hide();
            $('.ss_'+data[4][i]['id']).html(parseFloat(data[4][i]['tot_sale']).toFixed(2));
            $('.ss_'+data[4][i]['id']).show(500);

            $('.ss_count_'+data[4][i]['id']).hide();
            $('.ss_count_'+data[4][i]['id']).html(parseFloat(data[4][i]['sales_count']).toFixed(2));
            $('.ss_count_'+data[4][i]['id']).show(500);

        }
        // $('.purchase_return-data').hide();
        // $('.purchase_return-data').html(parseFloat(data[4]).toFixed(2));
        // $('.purchase_return-data').show(500);
    }
</script>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ikinzico/system.secretsoftea.lk/development/develop2/resources/views/index.blade.php ENDPATH**/ ?>