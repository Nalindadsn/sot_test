        ...
        <div class="card">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3 mt-3" hidden>
                    <div class="form-group row">
                        <label class="d-tc mt-2"><strong>Choose Billers</strong> &nbsp;</label>
                        <div class="d-tc">
                            ...
                            <select id="biller_id" name="biller_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" >
                                <option value="0">All Billers</option>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salespro\resources\views/report/sale_report.blade.php ENDPATH**/ ?>