...
class ReportController extends Controller
{
                ...
                if($product->is_variant) {
                    ...
                    foreach ($variant_id_all as $key => $variant_id) {
                        ...
                        if($product_warehouse)
                            $nestedData['in_stock'] = $product_warehouse;
                        else
    ...
    public function saleReport(Request $request)
    {
        ...
        foreach ($lims_product_all as $product) {
            ...
            elseif($warehouse_id != 0 && $biller_id == 0) {
                if($product->is_variant)
        ...
        return view('report.sale_report',compact('product_id', 'variant_id', 'product_name', 'product_qty', 'start_date', 'end_date', 'lims_warehouse_list','warehouse_id','lims_biller_list','biller_id'));
    }
