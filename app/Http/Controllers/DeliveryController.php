...
class DeliveryController extends Controller
{
    ...
    public function create($id){
    	...
    	if($lims_delivery_data){
    		$customer_sale = DB::table('sales')->join('customers', 'sales.customer_id', '=', 'customers.id')->where('sales.id', $id)->select('sales.id','sales.reference_no','customers.name','customers.phone_number')->get();
    		...
    		$customer_sale = DB::table('sales')->join('customers', 'sales.customer_id', '=', 'customers.id')->where('sales.id', $id)->select('sales.id','sales.reference_no','customers.name', 'customers.address', 'customers.city', 'customers.country', 'customers.phone_number')->get();

//    		return $customer_sale;
    		$delivery_data[] = 'DR' . ($customer_sale[0]->id + 1000);
    		$delivery_data[] = $customer_sale[0]->reference_no;
    		$delivery_data[] = '';
    		$delivery_data[] = '';
    		$delivery_data[] = '';
